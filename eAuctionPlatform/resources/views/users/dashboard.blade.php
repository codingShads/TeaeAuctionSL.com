...
@section('UserUI')
    ...
    <div class="flex bg-blue-100">
        <div class="flex flex-row p-6 m-6 w-full mx-auto justify-around">

            <div class="block max-w-sm rounded-lg bg-white shadow-lg dark:bg-neutral-700 p-6 m-6">
                <a href="#!">
    ...
    <div class="flex flex-col m-auto p-10 bg-blue-100">
    ...
    <div class="px-24 mx-52 my-5 border-solid border-2 border-fuchsia-950 rounded-lg overflow-y-auto h-80">
        <ul>
            ...
            <li class="mx-5 my-5 py-2  marker:border-solid border-2 border-fuchsia-950 rounded-lg">
                <div class="flex justify-around">
                    <div>
                        <a href="#!">
                            <img class=" w-64" src="https://tecdn.b-cdn.net/img/new/standard/nature/184.jpg" alt="" />
